...
1:      Me.Show()
    ...
    Private Sub internet()
        Try
            My.Computer.Network.Ping("www.google.ro")
            InternetLabel.Text = "ONLINE"
            InternetLabel.BackColor = Color.Green
            InternetLabel.ForeColor = Color.White

        Catch
            InternetLabel.Text = "OFFLINE"
            InternetLabel.BackColor = Color.Red
            InternetLabel.ForeColor = Color.White
        End Try
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        MessageBox.Show("Press browse, to browse for the dll, and after that wrote process name, alos works without internet connection, use close after inject to close the program after injection succesfully made")
    End Sub
End Class
